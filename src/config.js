export const app_config = {
  ...
  redirect_uri: "https://expose-center.vercel.app/callback",
  owner_ids: ["899263378143473695", "1435621020001108069"],
  server_id: "1487863855798288467",
  default_types: ["pedophile", "skid", "doxxer", "scammer", "other"],
  badge_thresholds: [
    { min: 1500, name: "diamond", label: "Diamond", color: "#b9f2ff" },
    { min: 2000, name: "platinum", label: "Platinum", color: "#e5e4e2" },
    { min: 5000, name: "emerald", label: "Emerald", color: "#50c878" },
    { min: 10000, name: "verified", label: "Verified", color: "#1d9bf0" }
  ]
};
